...
import { DuonMapView, DuonWayfinding, type DuonMall } from "@dtechph/wayfinding-web";
    ...
    <div className="min-h-dvh bg-zinc-50">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <p className="mt-2 max-w-2xl text-zinc-600">
          ...
          fills its parent, so give it an explicit height when it is not the
          full page. This sample drops it into a card at 480px, with a custom
          mall picker that calls{" "}
          <code className="rounded bg-zinc-200/80 px-1.5 py-0.5 font-mono text-[0.9em]">
            setActiveMall
          </code>
          .
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[240px_1fr]">
          ...
          <section className="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
            ...
            {selectedMall ? (
              <DuonMapView mall={selectedMall} style={{ height: 480 }} />
            ) : (
